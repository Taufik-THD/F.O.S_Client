...
import { updateChef } from '../store/action'
import axios from 'axios'

class addNewChef extends Component {
  ...
  handleSubmit (event) {
    ...
    axios({
      ...
      this.props.updateChef(data.data);
...
function mapDispatchToProps(dispatch) {
  return {
    updateChef: (payload) => dispatch(updateChef(payload))
  }
}

export default connect(null, mapDispatchToProps)(addNewChef);
